package com.marianm.web.rest;

import com.marianm.MontibellerTestApp;

import com.marianm.domain.Student;
import com.marianm.repository.StudentRepository;
import com.marianm.web.rest.errors.ExceptionTranslator;
...
import static com.marianm.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = MontibellerTestApp.class)
public class StudentResourceIntTest {
    ...
    private static final String DEFAULT_STRASSE_HAUSNUMMER = "AAAAAAAAAA";
    private static final String UPDATED_STRASSE_HAUSNUMMER = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .strasseHausnummer(DEFAULT_STRASSE_HAUSNUMMER)
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getStrasseHausnummer()).isEqualTo(DEFAULT_STRASSE_HAUSNUMMER);
    ...
    @Test
    @Transactional
    public void checkStrasseHausnummerIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setStrasseHausnummer(null);
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].strasseHausnummer").value(hasItem(DEFAULT_STRASSE_HAUSNUMMER.toString())))
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.strasseHausnummer").value(DEFAULT_STRASSE_HAUSNUMMER.toString()))
    ...
    public void updateStudent() throws Exception {
        ...
        updatedStudent
            ...
            .strasseHausnummer(UPDATED_STRASSE_HAUSNUMMER)
        ...
        assertThat(testStudent.getStrasseHausnummer()).isEqualTo(UPDATED_STRASSE_HAUSNUMMER);
